...
public:
    ...
    pthread_mutex_t _prepare_buffer_lock, _prepare_flush_lock;
    pthread_cond_t _prepare_buffer_signal, prepare_buffer_condition;
    ...
    pthread_mutex_t _commit_buffer_lock, _commit_flush_lock;
    pthread_cond_t _commit_buffer_signal, commit_buffer_condition;
